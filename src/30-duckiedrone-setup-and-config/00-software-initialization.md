...
The Duckiedrone uses a Raspberry Pi as an onboard "companion" computer. The Raspberry Pi requires a Duckietown-specific operating system to work, and this section details two ways to do so:
...
If you use Ubuntu, the [fast way](dd24-sw-init-fast) also supports customization.
