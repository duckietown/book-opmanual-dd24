```{seo}
:description: Reference datasheets for Duckiedrone flight controllers, sensors, power electronics, and Raspberry Pi hardware.
:keywords: Duckiedrone, datasheets, flight controller, camera, ToF sensor, Raspberry Pi, ESC, power electronics
```
...
:alt: SP Racing F3 OSD flight controller beside a separate micro-USB breakout board
...
:alt: SP Racing F3 Acro flight controller with a built-in mini-USB port
...
:alt: Blue Time-of-Flight sensor board with a white circular sensor opening and four-pin connector
